...
if st.session_state['video_path']:
    ...
    if st.button("🚀 Start AI Gait Analysis", type="primary"):
        ...
        final_tremor = round((1.0 - avg_confidence) * 10, 1)
        ...
        # --- Display Final Dashboard (FIXED VIDEO SECTION) ---
        bar.empty()
        progress_text.empty()
        ...
        with v2:
            ...
            # Convert video using ffmpeg so it plays on all browsers
            converted_video = "output_fixed.mp4"
            os.system(f"ffmpeg -y -i {output_path} -vcodec libx264 {converted_video}")
